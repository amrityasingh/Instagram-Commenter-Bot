...
class Commenter:
    ...
    def login(self):
        ...
        login_button.click()
        time.sleep(2)
        user_name_elem = driver.find_element_by_xpath("/html/body/div[1]/section/main/div/article/div/div[1]/div/form/div[2]/div/label/input")
        user_name_elem.clear()
        user_name_elem.send_keys(self.usr)
        passworword_elem = driver.find_element_by_xpath("/html/body/div[1]/section/main/div/article/div/div[1]/div/form/div[3]/div/label/input")
...
com = Commenter(usr='hello_deeer', password='Yuphoria6999')
com.login()

for pic in com.get_pictures_on_page(hashtag='love', scrolls=1)[1:]:
    pict= driver.find_element_by_xpath("/html/body/div[1]/section/main/article/div[1]/div/div/div[1]/div[1]/a")
    pict.click()
    time.sleep(3)
